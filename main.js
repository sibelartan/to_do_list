...
function renderCategories() {
    categoriesContainer.innerHTML += `<li class="sidebar-item ${selectedCategoryId === 'null' || selectedCategoryId === null ? 'active' : ''}" data-category-id="">Tüm Kategoriler</li>
	`;
...
function renderFormOptions() {
    ...
    newTodoSelect.innerHTML += `<option value="">Kategori seçiniz</option>`;
    editTodoSelect.innerHTML += `<option value="">Kategori seçiniz</option>`;
